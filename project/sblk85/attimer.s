...
.Ldebug_macro2:
	...
	.long	.LASF433
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.timing.h.22.da98dd45997c75a9a2532c5aacb93234,comdat
.Ldebug_macro3:
	.word	0x4
	.byte	0
	.byte	0x5
...
.Ldebug_macro8:
	...
	.long	.LASF479
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.regtim85.h.23.4579bdd43b9e2d45a4707d2e74f40767,comdat
.Ldebug_macro9:
	.word	0x4
	.byte	0
	.byte	0x5
	...
	.long	.LASF563
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.interrupt.h.23.8a92a6073eaf9b1df8461d2df9a8600c,comdat
.Ldebug_macro10:
	.word	0x4
	.byte	0
	.byte	0x5
	...
	.long	.LASF446
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.attimerdefs.h.32.cd18fcc15adc78940bc2927364a582dc,comdat
.Ldebug_macro11:
	.word	0x4
	.byte	0
	.byte	0x5
...
.LASF500:
	.string	"CS0_CLK_EXT_RISING_EDGE CS0_0_2(7)"
.LASF614:
...
.LASF499:
	.string	"CS0_CLK_EXT_FALLING_EDGE CS0_0_2(6)"
.LASF180:
...
.LASF575:
	.string	"RCLK_DIV(d) RCLK_DIV1(d)"
.LASF494:
	.string	"CS0_CLK_DIV1 CS0_0_2(1)"
.LASF563:
...
.LASF501:
	.string	"RCLK_DIV0(d) ((d<=1)?1UL: (d<=8+(64-8)/2)?8UL: (d<=64+(256-64)/2)?64UL: (d<=256+(1024-256)/2)?256UL: 1024UL)"
.LASF293:
...
.LASF497:
	.string	"CS0_CLK_DIV256 CS0_0_2(4)"
.LASF580:
	.string	"W_TIFR TIFR1"
.LASF238:
...
.LASF484:
	.string	"COM1B1 BV_(5)"
.LASF496:
	.string	"CS0_CLK_DIV64 CS0_0_2(3)"
.LASF216:
...
.LASF529:
	.ascii	"RCLK_DIV1(d) ((d<=1)?1UL:(d<=2)?2UL"
...
.LASF502:
	.string	"SELCS0(d) ((d<=1)?CS0_CLK_DIV1: (d<=8+(64-8)/2)?CS0_CLK_DIV8: (d<=64+(256-64)/2)?CS0_CLK_DIV64: (d<=256+(1024-256)/2)?CS0_CLK_DIV256: CS0_CLK_DIV1024)"
.LASF465:
	.string	"SREG_N BV_(2)"
.LASF381:
...
.LASF498:
	.string	"CS0_CLK_DIV1024 CS0_0_2(5)"
.LASF272:
